...
## Chart
```{raw} html
<iframe src="../_static/SLTH/figure5_paper_sample.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: CRSP, RavenPack, OpenAI</p>
```
[Full Screen Chart](../download_chart/SLTH/figure5_paper_sample.html)
...
| Seasonal Adjustment    |                                     |
| Units                  |                                                   |
| HTML Chart             | [HTML](../download_chart/SLTH/figure5_paper_sample.html)    |
